                           ...
                           <div class="row">
                              ...
                              <div class="col-md-6 col-sm-6">
                                 <div class="add-product-form-group">
                                    ...
                                    @endif
                                    <form method="post" action="{{ route('store.chairmanmessage') }}"enctype="multipart/form-data">
                                       @csrf
                                        <div class="row">
                                       <div class="col-md-12">
                                          <div class="form-group">
                                             <label class="control-label">Title*</label>
                                             <input type="text" placeholder="Enter title" class="form-control" name="position"required value="{{ old('position') }}">
                                          </div>
                                       </div>
                                      </div>
                              ...
                              <div class="col-md-6 col-sm-6">
                                 <div class="add-product-image-upload">
                                    <h3 style="text-align: center;">chairma avatar *</h3>
                                    <!--<form> -->
                                       <div class="row">
                                          <div class="col-md-12">
