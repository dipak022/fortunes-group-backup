                                 ...
                                 @foreach($news_event as $row)
                                    <tr>
                                       ...
                                       <td >{{ $row->title }}</td><td >{!!$row->description !!}</td>
                                        <td class="d-flex">
                                          <a style="margin-top:5px;"href="{{ url('edit/event/'.$row->id) }}" class="product-table-info btn btn-success" data-toggle="tooltip" title="Edit"><i class="fa fa-pencil"style="color:white;"></i></a>
                                          <a style="margin-top:5px;" href="{{ url('delete/event/'.$row->id) }}" class="product-table-danger btn btn-danger" data-toggle="tooltip" title="Delete"><i class="fa fa-trash" style="color:white;"></i></a>
                                       </td>  
                                    </tr>
                                   @endforeach
                                 </tbody>
                        ...
                        <div class="modal-content">
                           ...
                           <div class="modal-body">
                              <div class="notes_sector">
                                 ...
                                 @endif
                                 <form method="post" action="{{ route('store.news_event') }}"enctype="multipart/form-data">
                                 	@csrf
                                    <p>
