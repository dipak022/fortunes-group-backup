                                 ...
                                 @foreach($latest_news as $row)
                                    <tr>
                                       ...
                                       <td >{!!$row->description !!}</td>
                                        <td class="d-flex">
                                          <a style="margin-top:5px;"href="{{ url('edit/latestnews/'.$row->id) }}" class="product-table-info btn btn-success" data-toggle="tooltip" title="Edit"><i class="fa fa-pencil"style="color:white;"></i></a>
                                          <a style="margin-top:5px;" href="{{ url('delete/latestnews/'.$row->id) }}" class="product-table-danger btn btn-danger" data-toggle="tooltip" title="Delete"><i class="fa fa-trash" style="color:white;"></i></a>
                                       </td>  
                                    </tr>
                                   @endforeach 
                                 </tbody>
                     ...
                     <div class="modal-dialog" role="document">
                        <div class="modal-content">
                           <div class="modal-header">
                              ...
                              <h4 class="modal-title" id="myModalLabel">Add New latest news</h4>
                           </div>
                           <div class="modal-body">
                              <div class="notes_sector">
                                 ...
                                 @endif
                                 <form method="post" action="{{ route('store.latestnews') }}"enctype="multipart/form-data">
                                 	@csrf
                                    <p>
                                     ...
                                     <p>
                                       ...
                                       <input type="text" class="picker_1" name="title" placeholder="title" required="" />
                                    </p> 
                                    <p>
                                        <label for="exampleInputEmail1">Date *</label>
                                       <input type="date" class="picker_1" name="date" placeholder="date" required="" />
                                    </p>
                                     <p>    
