                                 ...
                                 @foreach($businesslider as $row)
                                    <tr>
                                       ...
                                       <td >{{ $row->name }}</td>
                                        ...
                                        <td class="d-flex">
                                          <a style="margin-top:5px;"href="{{ url('edit/company/slidder/'.$row->id) }}" class="product-table-info btn btn-success" data-toggle="tooltip" title="Edit"><i class="fa fa-pencil"style="color:white;"></i></a>
                                          <a style="margin-top:5px;" href="{{ url('delete/company/slidder/'.$row->id) }}" class="product-table-danger btn btn-danger" data-toggle="tooltip" title="Delete"><i class="fa fa-trash" style="color:white;"></i></a>
                                       </td>  
                                    </tr>
                                   @endforeach 
                                 </tbody>
                     ...
                     <div class="modal-dialog" role="document">
                        <div class="modal-content">
                           <div class="modal-header">
                              ...
                              <h4 class="modal-title" id="myModalLabel">Add New business Slider</h4>
                           </div>
                           <div class="modal-body">
                              <div class="notes_sector">
                                 ...
                                 @endif
                                 <form method="post" action="{{ route('store.companyslidder') }}"enctype="multipart/form-data">
                                 	@csrf
                                    <p>
                                        <label for="exampleInputEmail1">Business Name</label>
                                       
                                         <select class="form-control" name="slider_id">
                                          <option disabled selected>Select Company Business</option>
