                              ...
                              <table id="datatables_example_1" class="table display table-bordered">
                                 ...
                                 @foreach($prassad as $row)     
                                  <tr>      
                                       ...
                                       <td class="d-flex">
                                          <a style="margin-top:5px;"href="{{ url('edit/prassad/'.$row->id) }}" class="product-table-info btn btn-success" data-toggle="tooltip" title="Edit"><i class="fa fa-pencil"style="color:white;"></i></a>
                                          <a style="margin-top:5px;" href="{{ url('delete/prassad/'.$row->id) }}" class="product-table-danger btn btn-danger" data-toggle="tooltip" title="Delete"><i class="fa fa-trash" style="color:white;"></i></a>
                                       </td>
                     ...
                     <div class="modal-dialog" role="document">
                        <div class="modal-content">
                           <div class="modal-header">
                              ...
                              <h4 class="modal-title" id="myModalLabel">Add New prass ad</h4>
                           </div>
                           <div class="modal-body">
                              <div class="notes_sector">
                                 ...
                                 @endif
                                 <form method="post" action="{{ route('store.prassad') }}"enctype="multipart/form-data">
                                  @csrf
