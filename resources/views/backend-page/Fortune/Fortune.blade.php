                                 ...
                                 @foreach($Fortune as $row)
                                    <tr>
                                       ...
                                       <td >{!!$row->short_description !!}</td>
                                        ...
                                        <td class="d-flex">
                                          <a style="margin-top:5px;"href="{{ url('edit/fortune/'.$row->id) }}" class="product-table-info btn btn-success" data-toggle="tooltip" title="Edit"><i class="fa fa-pencil"style="color:white;"></i></a>
                                          <a style="margin-top:5px;" href="{{ url('delete/fortune/'.$row->id) }}" class="product-table-danger btn btn-danger" data-toggle="tooltip" title="Delete"><i class="fa fa-trash" style="color:white;"></i></a>
                                       </td>
                        ...
                        <div class="modal-content">
                           ...
                           <div class="modal-body">
                              <div class="notes_sector">
                                 ...
                                 @endif
                                 <form method="post" action="{{ route('store.fortune') }}"enctype="multipart/form-data">
                                 	@csrf
                                    <p>
                                    ...
                                    <p>
                                       ...
                                       <input type="text" class="picker_1" name="priority" placeholder="Priority" required="" />
                                    </p>
                                    
                                    <p>
                                        <label for="exampleInputEmail1"> Website Link</label>
                                       <input type="text" class="picker_1" name="webside_link" placeholder="Website Link" required="" />
                                    </p>
                                     ...
                                     <div class="mail-editor">
                                      <div>
                                        <label>Description*</label>
                                         <textarea id="summernote" type="text" placeholder="Enter description"name="short_description" required >{{ old('short_description') }}</textarea>
                                      </div>
                                     </div>
                                    </div>
                                    </p>
