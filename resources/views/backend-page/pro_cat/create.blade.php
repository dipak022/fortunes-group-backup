                              ...
                              <div class="col-md-6 col-sm-6">
                                 <div class="seipkon-breadcromb-right">
                                    <ul>
                                       ...
                                       <li>project Category add</li>
                                       <li>project all Category</li>
                                    </ul>
                                 </div>
                              </div>
                           </div>
                              ...
                              <table id="datatables_example_1" class="table display table-bordered">
                                 ...
                                 <tbody>
                                    ...
                                    <tr>
                                       ...
                                       <td class="d-flex">
                                          <a style="margin-top:5px;"href="{{ url('edit/pro/category/'.$row->id) }}" class="product-table-info btn btn-success" data-toggle="tooltip" title="Edit"><i class="fa fa-pencil"style="color:white;"></i></a>
                                          <a style="margin-top:5px;" href="{{ url('delete/pro/category/'.$row->id) }}" class="product-table-danger btn btn-danger" data-toggle="tooltip" title="Delete"><i class="fa fa-trash" style="color:white;"></i></a>
                                       </td>
                        ...
                        <div class="modal-content">
                           ...
                           <div class="modal-body">
                              <div class="notes_sector">
                                 ...
                                 @endif
                                 <form method="post" action="{{ route('store.procategory') }}">
                                 	@csrf
                                     ...
                                     <p>
                                        <label for="exampleInputEmail1">Cetagory</label>
                                         ...
                                         <select class="form-control" name="companies_id">
                                          <option disabled selected>Select Besiness</option>
                                    ...
                                    <p>
                                       ...
                                       <input type="text" class="picker_1" name="cat_name" placeholder="Category Name"  />
                                    </p>
                                    <p>
                                    	 <label for="exampleInputEmail1">Priority</label>
                                       <input type="text" class="picker_1" name="priority" placeholder="Priority"/>
                                    </p>
